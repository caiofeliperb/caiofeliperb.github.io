            ...
            <div className="container footer-content">
                ...
                <div className="footer-credits">
                    ...
                    <p className="researchers">
                        Idealização, Pesquisa e Desenvolvimento: Caio Felipe Rodrigues Barbosa, Maria Eduarda Varela Cavalcanti Souto, Thales Allyrio Araújo de Medeiros Fernandes, Alícia Eliege da Silva, Milena Sonely Mendonça Bezerra Lima.
                    </p>
                </div>
            </div>
        </footer>
